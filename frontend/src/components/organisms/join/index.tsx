...
export default function JoinPage() {
  ...
  useEffect(() => {
    if (queryPlan) {
      const matched = ["Basic", "Silver", "Gold", "Premium"].find(
        (name) => name.toLowerCase() === queryPlan.toLowerCase()
      );
  ...
  useEffect(() => {
    if (planParam) {
      const formatted = planParam.charAt(0).toUpperCase() + planParam.slice(1).toLowerCase();
      if (["Basic", "Silver", "Gold", "Premium"].includes(formatted)) {
        setPlan(formatted);
      }
    }
  }, [planParam]);
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            >
              ...
              <option value="Silver" className="bg-zinc-900">Silver Plan (₹1499/mo)</option>
              <option value="Gold" className="bg-zinc-900">Gold Plan (₹2499/mo)</option>
              <option value="Premium" className="bg-zinc-900">Premium Plan (₹4999/mo)</option>
            </select>
          </div>
